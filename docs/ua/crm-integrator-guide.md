...
8. [Перевірка автентичності запитів](#8-перевірка-автентичності-запитів)
9. [Налаштування власного формату JSON](#9-налаштування-власного-формату-json)
10. [Поведінка системи при збоях доставки](#10-поведінка-системи-при-збоях-доставки)
11. [Приклад реалізації сервера-приймача](#11-приклад-реалізації-сервера-приймача)
12. [Питання, що часто виникають](#12-питання-що-часто-виникають)
13. [Контрольний список інтеграції](#13-контрольний-список-інтеграції)
...
Окрім прийому веб-хуків, CRM-система може самостійно звертатися до REST API PearlPBX2 — зокрема для ініціалізації вихідних дзвінків, а також (за потреби) для роботи зі списками номерів. Усі ендпоінти розташовані під префіксом `/api/v1/` і потребують автентифікації.
...
## 8. Перевірка автентичності запитів
...
## 9. Налаштування власного формату JSON
...
## 10. Поведінка системи при збоях доставки
...
## 11. Приклад реалізації сервера-приймача
...
## 13. Контрольний список інтеграції
